...
package() {
    ...
    rm libasn1.so.8 libcrypto.so.1.1 libcurl.so.4 libhogweed.so.4 libicudata.so* libicui18n.so* libicuuc.so* libidn.so.11 liblber-2.4.so.2 libldap_r-2.4.so.2 libnettle.so.6 librtmp.so.1 libssl.so.1.1 libxcb-* xcbglintegrations/libqxcb-xinerama.so.0
